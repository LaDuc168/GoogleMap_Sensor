...
public class ScreenCheckinActivity extends AppCompatActivity
        implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, LocationListener {

    public static final String TAG = ScreenCheckinActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_checkin);
        Log.d(TAG, "onCreate");
        initViews();
        ...
        mBtnGetLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isGpsOn()) {
                    ...
                    Toast.makeText(ScreenCheckinActivity.this, "GPS is OFF", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mSwAutoUpdateLocation.setOnCheckedChangeListener(
                new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        if (!isGpsOn()) {
                            Toast.makeText(ScreenCheckinActivity.this, "GPS is OFF",
    ...
    private void updateUi() {
        if (mLastLocation != null) {
            ...
            Intent intent=new Intent(ScreenCheckinActivity.this,CheckinMapsUpdateActivity.class);
            intent.putExtra("LAT",mLastLocation.getLatitude());
            intent.putExtra("LNG",mLastLocation.getLongitude());
            startActivity(intent);
//            Toast.makeText(this, "x="+mLastLocation.getLatitude()+"y="+mLastLocation.getLongitude(), Toast.LENGTH_SHORT).show();
        }
    }
