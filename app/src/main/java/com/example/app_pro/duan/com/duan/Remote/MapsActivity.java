package com.example.app_pro.duan.com.duan.Remote;
...
//    IGoogleAPIService mService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(android.R.layout.activity_maps);
        ...
        BottomNavigationView bottomNavigationView = findViewById(android.R.id.bottom_navigation);
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            @Override
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case android.R.id.action_hospital:
                        nearByPlace("hospital");
                        break;
                    case android.R.id.action_market:
                        nearByPlace("market");
                        break;
                    case android.R.id.action_restaurant:
                        nearByPlace("restaurant");
                        break;
                    case android.R.id.action_school:
                        nearByPlace("school");
                        break;
                    default:
                        break;
                        ...
                        if (response.isSuccessful()) {
                            for (int i = 0; i < response.body().getResults().length; i++) {
                                ...
                                if (placeType.equals("hospital"))
                                    markerOptions.icon(BitmapDescriptorFactory.fromResource(android.R.drawable.maker_hospital));
                                else if (placeType.equals("school"))
                                    markerOptions.icon(BitmapDescriptorFactory.fromResource(android.R.drawable.maker_school));
                                else if (placeType.equals("market"))
                                    markerOptions.icon(BitmapDescriptorFactory.fromResource(android.R.drawable.maker_shop));
                                else if (placeType.equals("restaurant"))
                                    markerOptions.icon(BitmapDescriptorFactory.fromResource(android.R.drawable.maker_restaurant));
                                else
...
//                Toast.makeText(MapsActivity.this, "Ok="+marker.getSnippet(), Toast.LENGTH_SHORT).show();
...
//                Results kq = currentPlace.getResults()[Integer.parseInt(marker.getSnippet())];
//                mService = Common.getGoogleAPIService();
//                mService.getDetailPlace(getPlaceDetailUrl(kq.getPlace_id()))
//                        .enqueue(new Callback<PlaceDetail>() {
//                            @Override
//                            public void onResponse(Call<PlaceDetail> call, Response<PlaceDetail> response) {
//                                mPlace =response.body();
//                                String lat = mPlace.getResult().getGeometry().getLocation().getLat();
//                                String lng = mPlace.getResult().getGeometry().getLocation().getLng();
//
